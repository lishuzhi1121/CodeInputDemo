...
@implementation SLBlockCodeView
...
- (void)textFieldEditingChanged:(UITextField *)textField {
    ...
    if (textField.text.length >= self.itemCount) {
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(blockCodeViewDidInputCompleted:)]) {
            [_delegate blockCodeViewDidInputCompleted:self];
        }
    }
}
